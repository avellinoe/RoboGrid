...
namespace elma {
    ...
    using namespace std::chrono;
     ...
     //! Derived classes should implement the init, start, update, and stop methods.
     ...
     class Process {
        ...
        */
        ...
        // void watch(string event_name, std::function<void(Event&)> handler); // original
        // void watch(string, std::function<void(Event&)>, int); // 3 args, default
        void watch(string event_name, std::function<void(Event&)> handler, int priority=0); // priority as default
